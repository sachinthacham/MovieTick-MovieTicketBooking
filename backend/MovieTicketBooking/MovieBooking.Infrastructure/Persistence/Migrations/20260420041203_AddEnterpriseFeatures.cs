        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosterType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TheaterFacilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TheaterFacilities_Theaters_TheaterId",
                        column: x => x.TheaterId,
                        principalTable: "Theaters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TheaterImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TheaterImages_Theaters_TheaterId",
                        column: x => x.TheaterId,
                        principalTable: "Theaters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TheaterRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TheaterRatings_Theaters_TheaterId",
                        column: x => x.TheaterId,
                        principalTable: "Theaters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TheaterRatings_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScreenId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShowFormatId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LanguageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Showtimes_ShowFormats_ShowFormatId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShowtimePricings_SeatCategories_SeatCategoryId",
                        column: x => x.SeatCategoryId,
                        principalTable: "SeatCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShowtimePricings_SeatCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Showtimes_ShowFormatId",
                table: "Showtimes",
                column: "ShowFormatId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TheaterFacilities_TheaterId",
                table: "TheaterFacilities",
                column: "TheaterId");

            migrationBuilder.CreateIndex(
                name: "IX_TheaterImages_TheaterId",
                table: "TheaterImages",
                column: "TheaterId");

            migrationBuilder.CreateIndex(
                name: "IX_TheaterRatings_TheaterId",
                table: "TheaterRatings",
                column: "TheaterId");

            migrationBuilder.CreateIndex(
                name: "IX_TheaterRatings_UserId",
                table: "TheaterRatings",
                column: "UserId");
