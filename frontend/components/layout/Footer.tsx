      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="space-y-4">
          ...
          <p className="text-sm text-(--muted-foreground) max-w-xs">
            The premium destination for booking your favourite movies, events, and experiences.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-(--muted-foreground)">
            <li><Link href="/" className="hover:text-(--foreground) transition-colors">Now Showing</Link></li>
            <li><Link href="/" className="hover:text-(--foreground) transition-colors">Coming Soon</Link></li>
            <li><Link href="/theatres" className="hover:text-(--foreground) transition-colors">Theatres</Link></li>
            <li><Link href="/offers" className="hover:text-(--foreground) transition-colors">Offers & Promos</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-(--muted-foreground)">
            ...
            <li><Link href="#" className="hover:text-(--foreground) transition-colors">Cancellation Policy</Link></li>
